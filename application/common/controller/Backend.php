...
class Backend extends Controller
{
     ...
     * @return array
     */
    protected function buildparams2($searchfields = null, $relationSearch = null, $replaceKey = [])
    {
        ...
        foreach ($filter as $k => $v) {
            ...
            switch ($sym) {
                ...
                case 'NOT RANGE':
                    ...
                    $tableArr = explode('.', $k);
                    if (!$replaceKey && count($tableArr) > 1 && $tableArr[0] != $name && !in_array($tableArr[0], $alias) && !empty($this->model)) {
                        //修复关联模型下时间无法搜索的BUG
